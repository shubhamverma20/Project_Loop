...
import { TestFeedbackCard } from "@/components/TestFeedbackCard"
import { DirectApiDocCard } from "@/components/DirectApiDocCard"
...
export default function SourcesPage() {
  ...
  const handleSimulateSync = async (channelName: string) => {
    ...
    try {
      const res = await api.post("/api/feedback/sync", { channelName })
    ...
    <div className="space-y-6 max-w-5xl mx-auto">
      <div>
        ...
        <p className="text-sm text-zinc-500 dark:text-zinc-400 mt-1">
          Ingest customer feedback via Smart CSV Upload, Live Test Ingestion, or Active Integrations.
        </p>
      </div>
      ...
      {/* Direct REST API Integration & Documentation Section */}
      <DirectApiDocCard />

      {/* CSV Upload & Live Test Feedback Grid */}
